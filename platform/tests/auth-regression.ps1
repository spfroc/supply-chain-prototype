...
$register=Request POST "/api/auth/register" @{enterpriseId=1;username=$username;password=$password;realName="REGISTER-USER";phone="13800138901"} @{} $registerSession
...
$bad=Request POST "/api/auth/login" @{enterpriseId=1;username=$username;password="wrong-password"}
...
$login=Request POST "/api/auth/login" @{enterpriseId=1;username=$username;password=$password} @{} $loginSession
